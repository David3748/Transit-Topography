...
export const POSTER_THEMES: Record<string, PosterTheme> = {
    noir: {
        ...
        bands: ['#ffffff', '#dedede', '#b8b8b8', '#909090', '#686868', '#484848', '#2a2a2a', '#181818'],
        bandOpacity: 0.85,
        waterColor: '#050510',
        streetColor: '#333333',
        streetOpacity: 0.12,
    ...
    blueprint: {
        ...
        bands: ['#e0f4ff', '#a8e0ff', '#67c8ff', '#38a8e0', '#1a88c0', '#0e6898', '#064870', '#032840'],
        bandOpacity: 0.8,
        waterColor: '#040c18',
        streetColor: '#1a4060',
        streetOpacity: 0.15,
    ...
    neon: {
        ...
        bands: ['#ff2afc', '#e040d0', '#b850e8', '#8060ff', '#5080ff', '#30b0ff', '#10d8e0', '#00ffcc'],
        bandOpacity: 0.75,
        waterColor: '#06040e',
        streetColor: '#2a1848',
        streetOpacity: 0.15,
    ...
    ink_wash: {
        ...
        bands: ['#2a3848', '#3a4c60', '#4a6078', '#607890', '#7890a8', '#90a8b8', '#b0c0cc', '#d0d8e0'],
        bandOpacity: 0.6,
        waterColor: '#d8dce0',
        streetColor: '#a8a098',
        streetOpacity: 0.1,
    ...
    sunset: {
        ...
        bands: ['#ffe040', '#ffc020', '#ff9020', '#ff6830', '#e84830', '#c03060', '#882868', '#502060'],
        bandOpacity: 0.8,
        waterColor: '#0a0408',
        streetColor: '#3a2020',
        streetOpacity: 0.12,
    ...
    ocean: {
        ...
        bands: ['#e0fff8', '#a0f0e0', '#60e0c8', '#30c8b0', '#18a898', '#0e8880', '#066858', '#034838'],
        bandOpacity: 0.78,
        waterColor: '#030a12',
        streetColor: '#184050',
        streetOpacity: 0.12,
    ...
    forest: {
        ...
        bands: ['#e0ffc0', '#b0f070', '#80e840', '#58c828', '#38a818', '#288810', '#186808', '#0e4804'],
        bandOpacity: 0.78,
        waterColor: '#040a06',
        streetColor: '#1a3818',
        streetOpacity: 0.12,
    ...
    copper: {
        ...
        bands: ['#f0c880', '#d8a860', '#d08848', '#b87038', '#986030', '#785838', '#587060', '#4a8880'],
        bandOpacity: 0.8,
        waterColor: '#080604',
        streetColor: '#38302a',
        streetOpacity: 0.12,
