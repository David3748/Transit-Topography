...
export const WALKING_NETWORK_CITIES = [
    ...
    'vancouver', 'mexico_city', 'london', 'paris', 'berlin',
    'amsterdam', 'copenhagen', 'madrid', 'barcelona', 'oslo',
    'helsinki', 'prague', 'hong_kong', 'sydney', 'melbourne',
    'sao_paulo'
];
...
export const CITIES: Record<string, CityConfig> = {
    ...
    'nyc': {
        ...
        busFiles: ['transit_data/nyc_bus_manhattan_bus.json', 'transit_data/nyc_bus_brooklyn_bus.json'],
    ...
    'dc': {
        ...
        water: 'transit_data/water_dc.json'
    },
    'la': {
        name: 'Los Angeles', flag: '\u{1F1FA}\u{1F1F8}', region: 'north_america',
        center: [34.0522, -118.2437], zoom: 11,
        files: ['transit_data/la.json'],
        water: 'transit_data/water_la.json'
    },
    'seattle': {
        ...
        water: 'transit_data/water_seattle.json'
    },
    'portland': {
        ...
        water: 'transit_data/water_portland.json'
    },
    'toronto': {
        ...
        water: 'transit_data/water_toronto.json'
    },
    'montreal': {
        ...
        water: 'transit_data/water_montreal.json'
    },
    'vancouver': {
    ...
    'london': {
        ...
        water: 'transit_data/water_london.json'
    },
    'paris': {
        ...
        water: 'transit_data/water_paris.json'
    },
    'berlin': {
        ...
        water: 'transit_data/water_berlin.json'
    },
    'amsterdam': {
        ...
        water: 'transit_data/water_amsterdam.json'
    },
    'copenhagen': {
        ...
        water: 'transit_data/water_copenhagen.json'
    },
    'madrid': {
        name: 'Madrid', flag: '\u{1F1EA}\u{1F1F8}', region: 'europe',
        center: [40.4168, -3.7038], zoom: 12,
        files: ['transit_data/madrid.json'],
        water: 'transit_data/water_madrid.json'
    },
    'barcelona': {
        name: 'Barcelona', flag: '\u{1F1EA}\u{1F1F8}', region: 'europe',
        center: [41.3851, 2.1734], zoom: 12,
        files: ['transit_data/barcelona.json'],
        water: 'transit_data/water_barcelona.json'
    },
    'oslo': {
    ...
    'melbourne': {
        ...
        water: 'transit_data/water_melbourne.json'
    },
    // South America
    'sao_paulo': {
        ...
        water: 'transit_data/water_sao.json'
    }
};
