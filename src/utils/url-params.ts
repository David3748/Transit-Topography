...
export function getUrlParams(): { city: string | null; lat: number | null; lng: number | null; hour: number | null } {
...
export function updateUrl(city: string, lat: number, lng: number, hour?: number): void {
